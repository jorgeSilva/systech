  ...
  return (
    <section className={style.suporte__container}>
      <div className={style.suporte__content__apresentation}>
        <h1 className={style.suporte__title}>Possiveis duvidas sobre à SysTech Solutions<span style={{color:'var(--p1'}}>.</span></h1>
      ...
      <section className={style.suporte__content}>
        {
          ...
          <div className={style.suporte__card} onClick={handleClick} id='primeiro'>
            ...
            <p className={style.suporte__card__text} id='primeiro'>
              Plataformas web totalmente responsivas, desenvolvidas em Reac + TypeScript e node para manipulação do backend e contrução de API's<span id='primeiro'>.</span><br/>
...

        {
          ...
          <div className={style.suporte__card} onClick={handleClick} id='segundo'>
            ...
            <p className={style.suporte__card__text} id='segundo'>
              Formada unicamente por um membro responsavel por todas as areas do desenvolvimento, atuando no mercado de desde 2023, com 4 projetos reais em produção<span id='segundo'>.</span>
            </p>
          </div>
          :
          <div className={style.suporte__card} onClick={handleClick} id='segundo'>
          ...
          <div className={style.suporte__card} onClick={handleClick} id='terceiro'>
            <span className={style.suporte__card__span} id='terceiro'>
              <h1 className={style.suporte__card__title} id='terceiro'>
                Informações pertinentes ao unico desenvolvedor
              </h1>
            ...
            <p className={style.suporte__card__text} id='terceiro'>
              Jorge Lucas Ferreira Silva, fundador e unico membro da "SysTech"<span id='terceiro'>.</span> <br />
              Com titulo em "Técnico em Desenvolvimeto de Sistemas" pela escola técnica do estado de São Paulo, "ETEC Dr. Demétrio Azevedo Junior"<span id='terceiro'>.</span>
